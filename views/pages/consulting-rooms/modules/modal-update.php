<div class="modal fade" id="modal-update-consulting-room" tabindex="-1" aria-labelledby="modal-update-consulting-roomLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header">
                <h1 class="modal-title fs-5" id="modal-update-consulting_roomLabel">Editar Consultorio</h1>
                <button type="button" class="btn-close bg-white" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>

            <form class="g-3 needs-validation d-flex flex-column justify-content-evenly" id="form-update-consulting-room" novalidate>
